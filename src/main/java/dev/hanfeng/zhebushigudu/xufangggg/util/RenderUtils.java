...
import dev.hanfeng.zhebushigudu.xufangggg.util.gl.GLTexture;
import dev.hanfeng.zhebushigudu.xufangggg.util.gl.PNGDecoder;
...
public class RenderUtils
{
    ...
    public static Void drawTexture(ResourceLocation location,int x,int y,int textureX,int textureY,int width,int height){
        ...
        bufferbuilder.pos((double)(x + 0), (double)(y + height), (double)0.0D).tex((double)((float)(textureX + 0) * 0.00390625F), (double)((float)(textureY + height) * 0.00390625F)).endVertex();
        bufferbuilder.pos((double)(x + width), (double)(y + height), (double)0.0D).tex((double)((float)(textureX + width) * 0.00390625F), (double)((float)(textureY + height) * 0.00390625F)).endVertex();
        bufferbuilder.pos((double)(x + width), (double)(y + 0), (double)0.0D).tex((double)((float)(textureX + width) * 0.00390625F), (double)((float)(textureY + 0) * 0.00390625F)).endVertex();
        bufferbuilder.pos((double)(x + 0), (double)(y + 0), (double)0.0D).tex((double)((float)(textureX + 0) * 0.00390625F), (double)((float)(textureY + 0) * 0.00390625F)).endVertex();
        tessellator.draw();
        return null;
    }

    public static Void drawTexture2(InputStream inputStream,int x,int y,int textureX,int textureY,int width,int height){
