...
public class HotbarRefill extends Module {
    ...
    private final Setting<Integer> threshold = register(new Setting<Integer>("Threshold", 32, 1, 63));
    private final Setting<Integer> tickDelay = register(new Setting<Integer>("Tick Delay", 2, 1, 10));
